...
export default class NFC extends Component{
	...
	calculateNFC(survey){
		...
		let attention = survey.data['question19'];
		localStorage.setItem('attentionnfc', attention );
	...
	render(){
		...
		const surveyJSON = {"pages":[{"name":"page1","elements":[
			...
			{"type":"rating","name":"question19","title":"If you are paying attention, please fill in 4.","isRequired":true,"rateValues":[1,2,3,4,5]},
