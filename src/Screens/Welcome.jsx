	...
	render(){
		...
		return(
			...
			>
				...
				<p>During this study, you are being invited to create two playlists in a music recommender system built upon Spotify.
					To participate in this study, you will need to log in to your Spotify account and fill in some questionnaires.</p>
				<p>Please note that this application is not developed for a mobile environment, so please switch to a desktop if you opened this experiment on a mobile phone.</p>
				<p>
